...
void CArgument::calc(const unsigned long long &ullTFIndex, const long double &ldblTimeFrame,
                     ...
                     const long double &ldblEndTime)
{
    ...
    if (nextElement != nullptr)
        nextElement->calc(ullTFIndex, ldblTimeFrame, ldblStartTime, ldblTimeStep, ldblEndTime);
}